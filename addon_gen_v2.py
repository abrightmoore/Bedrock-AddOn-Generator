...
'''
    Added Resource pack dependancy on Behavior pack by UUID
...
#  Instructions:
SEED = random.randint(10000000,999999999999)# 0x726f626f74732072756c65206f6b  #  CHANGE THIS VALUE FOR UNIQUE UUIDs AND TEXTURES
...
class AddOn:
    ...
    def render_to_files(self):
        ...
        ft = AddOn.Tools()
        ROOT_RP = ft.clean_string(self.lang["pack.name"].lower()+"_rp")
        ROOT_BP = ft.clean_string(self.lang["pack.name"].lower()+"_bp")
        ...
        manifest_bp_uuid = ft.make_uuid(self.R)
        manifest_rp = {
            "format_version": 2,
            "header": {
